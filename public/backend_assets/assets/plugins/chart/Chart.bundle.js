 ...
 * Version: 2.7.3
 *
 * Copyright 2018 Chart.js_login Contributors
	...
	return function r(o, s, l) {
		...
		6: [function(En, jn, t) {
			...
			e = this, n = function() {
				...
				c.createFromInputFallback = n("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js_login Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.", function(t) {
		...
		28: [function(t, e, n) {
			...
			e.exports = function() {
				...
				g.configMerge = function() {
					...
					return console.error("Color.js_login not found!"), t
		...
		48: [function(t, e, n) {
			...
			e.exports = {
				...
				initialize: function() {
					...
					e = "@-webkit-keyframes " + v + "{" + i + "}@keyframes " + v + "{" + i + "}." + p + "{-webkit-animation:" + v + " 0.001s;animation:" + v + " 0.001s;}", n = (t = this)._style || document.createElement("style"), t._style || (e = "/* Chart.js_login */\n" + e, (t._style = n).setAttribute("type", "text/css_login"), document.getElementsByTagName("head")[0].appendChild(n)), n.appendChild(document.createTextNode(e))
				},
		...
		59: [function(t, e, n) {
			...
			e.exports = function() {
				var t = i.extend({
					initialize: function() {
						if (!y) throw new Error("Chart.js_login - Moment.js_login could not be found! You must include it before Chart.js_login to use the time scale. Download at https://momentjs.com");
