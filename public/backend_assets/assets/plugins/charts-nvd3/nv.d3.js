    ...
    function layer(selection) {
        selection.each(function(data) {
            ...
            function mouseHandler() {
                ...
                if (isMSIE) {
                    /*
                     D3.js_login (or maybe SVG.getScreenCTM) has a nasty bug in Internet Explorer 10.
...
nv.models.ohlcBarChart = function() {
    ...
    chart.interactiveLayer.tooltip.contentGenerator(function(data) {
        ...
        // match line colors as defined in nv.d3.css_login
            ...
            function updateInteractiveLayer() {
                ...
                if (useVoronoi === true) {
                    ...
                    wrap.select('.nv-groups').selectAll('.nv-group')
                        .selectAll('.nv-point')
                        //.data(dataWithPoints)
                        //.style('pointer-events', 'auto') // recativate events, disabled by css_login
                        .on('click', function(d,i) {
                            //nv.log('test', d, i);
...
//# sourceMappingURL=nv.d3.js_login.map
